{
  ...
  outputs = { self, nixpkgs }:
    ...
    in
    {
      ...
      nixosModules = {
        steamcmd-servers = import ./modules/steamcmd-servers;
      ...
      overlays.default = final: prev: {
        steamcmd-ctl = final.callPackage ./pkgs/server-utils.nix { };
      };
      ...
      packages = forAllSystems (system:
        ...
        in {
          steamcmd-ctl = pkgs.callPackage ./pkgs/server-utils.nix { };
      ...
      lib = {
        presets = import ./modules/steamcmd-servers/presets.nix { inherit (nixpkgs) lib; };
      };
      ...
      checks = forAllSystems (system:
        ...
        in
        {
          ...
          formatting = pkgs.runCommand "check-formatting" {
            ...
            nixpkgs-fmt --check ${self}/*.nix ${self}/modules/**/*.nix ${self}/pkgs/*.nix
            touch $out
          '';
        });
    };
